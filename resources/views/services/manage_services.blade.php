    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card card_style">
                <div class="card-header card_header text-header">Manage Services</div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($services as $service)
                                <tr class="table_row">
                                    <td class="table_row">{{$service->user->name}}</td>
                                    <td class="table_row">{{$service->title}}</td>
                                    <td class="table_row">
                                        <img class="circle_image" src="{{$service->image_path}}" alt="Service Image" width="50" height="50">
                                    </td>
